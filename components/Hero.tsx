...
export function Hero({
  ...
  return (
    <section className='relative -mt-[7.75rem] h-svh overflow-hidden md:-mt-[16rem]'>
      <Image
      ...
      <div className='relative flex h-full flex-col items-center justify-center px-6 text-center md:px-12'>
        ...
        <Link
          className='mt-8 rounded-md bg-silver px-6 py-3 tracking-wide text-espresso hover:opacity-90'
          href={cta.href}
        >
          {cta.label}
        </Link>
