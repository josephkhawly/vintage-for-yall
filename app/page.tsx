  ...
  return (
    <div className='flex min-h-[70vh] items-center justify-center'>
      <article className='w-full max-w-xl text-left font-body text-lg leading-relaxed md:text-xl md:leading-relaxed'>
        <p className='mb-6'>To my vintage-loving baddies,</p>

        <p className='mb-4'>
          Our first drop goes live October 2 at 12:00PM PST.
          <br />
          Sign up below to get first dibs on this &amp; future pieces plus an exclusive
          welcome discount.
        </p>
        ...
        <p className='mb-6'>
          In the meantime, you can buy from us on{' '}
          <a
        ...
        <p className='mb-6'>Can&apos;t wait to share more with you!</p>
